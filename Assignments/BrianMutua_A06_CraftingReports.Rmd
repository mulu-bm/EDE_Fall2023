...
```{r ozonelevels2018boxplot, echo=FALSE, warning=FALSE, fig.width=6, fig.height=4, fig.align='left', fig.cap='Monthly Ozone, 2018'}
#Setting up boxplot of Ozone levels by month in 2018
ozoneByMonth2018 <- epa_data %>% 
  filter(Year==2018) %>% 
...
#Printing out boxplot
print(ozoneByMonth2018)
```

```{r ozonelevels2019boxplot, echo=FALSE, warning=FALSE, fig.width=6, fig.height=4, fig.align='left', fig.cap='Monthly Ozone, 2019'}
#Setting up boxplot of Ozone levels by month in 2019
ozoneByMonth2019 <- epa_data %>% 
  filter(Year==2019) %>% 
  ggplot(aes(x=factor(Month, levels=1:12, labels=month.abb),
             y=Ozone))+
  geom_boxplot()+
...
## Git Repository
[https://github.com/mulu-bm/EDE_Fall2023](https://github.com/mulu-bm/EDE_Fall2023)
