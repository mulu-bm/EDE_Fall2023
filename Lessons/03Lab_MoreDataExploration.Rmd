...
ten_day_temp_high_forecast_f <- c(81,83,83,84,78,71,79,82,85,84)
ten_day_temp_low_forecast_f <- c(55,56,58,60,61,63,63,64,64,63)
...
```{r DataExercise-1b}
fahrenheit_to_celsius <- function(temp_in_fahrenheit){
  return((temp_in_fahrenheit-32)*5/9)
}

ten_day_temp_high_forecast_c <- fahrenheit_to_celsius(ten_day_temp_high_forecast_f)

ten_day_temp_low_forecast_c <- fahrenheit_to_celsius(ten_day_temp_low_forecast_f)
...
df_ten_day_temp_forecast <- data.frame(ten_day_temp_high_forecast_f,ten_day_temp_high_forecast_c,ten_day_temp_low_forecast_f,ten_day_temp_low_forecast_c)
colnames(df_ten_day_temp_forecast) <- c("Ten-Day Temp. High Forecast (F)","Ten-Day Temp. High Forecast (C)","Ten-Day Temp. Low Forecast (F)","Ten-Day Temp. Low Forecast (C)")
...
summary(df_ten_day_temp_forecast)
sd(df_ten_day_temp_forecast$`Ten-Day Temp. High Forecast (F)`)
