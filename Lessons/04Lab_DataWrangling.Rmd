...
NTL.phys.data.1990thru1999 <- filter(NTL.phys.data, year4 >= 1990 & year4 <=1999 & lakename == "Tuesday Lake")
...
NTL.phys.data.TuesdayLake.surface <-
  NTL.phys.data.TuesdayLake %>% 
  filter(depth == 0 & temperature_C != NA) %>% 
