...
ozoneByYearBoxplot <- ggplot(EPAair,aes(y=Ozone,x=as.factor(Year)))+
  geom_boxplot()+
...
print(ozoneByYearBoxplot)

ozoneByYearViolin <- ggplot(EPAair,aes(y=Ozone,x=as.factor(Year)))+
